...
const SelfAppraisalPage7 = () => {
    return (
        <div>
            <div className="font-bold mt-[10px]">
                <p>SECTION 4-HPO SELF PERFORMANCE</p>
            </div>
            ...
            <div className="border-1 border-[#D7D7D7] outline-none p-1 w-[1000px] rounded-md  px-2">
                <NO />
            </div>
        ...
        <>
            ...
            <div className="flex items-center gap-2 pt-[10px] pb-[10px]">
                ...
                <div className="text-sm">
                    Other ____________________________ 12345
                </div>
            </div>
        </>
    );
};
export default SelfAppraisalPage7;
