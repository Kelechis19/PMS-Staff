      ...
      <div className="flex items-center bg-white text-center mt-[20px]  font-[700] rounded-[10px] overflow-hidden  ">
        <div className={`w-full font-[700]`}>
          <Link to={`ongoing-task`}>
            <button className={`${activeTab === 1 ? "bg-[rgba(29,83,161,0.09)] rounded-[10px]" : ''} p-3 w-full rounded-[10px] text-[#205BB1]`} onClick={() => handleClick(1)}>Ongoing Task</button>
          </Link>
        </div>
        ...
        <div className="w-full font-[700]">
          <Link to={`task-history`}>
            <button className={`${activeTab === 3 ? "bg-[rgba(29,83,161,0.09)] " : ''} p-3 w-full rounded-[10px] text-[#205BB1]`} onClick={() => handleClick
