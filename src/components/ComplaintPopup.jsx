        ...
        <div className="absolute inset-0 w-screen max-h-screen flex flex-row items-center justify-center px-[10px]  bg-black/40 pt-[10px] border-b-[1px] border-b-[#656667]/10 ">
            ...
            <div className="w-[782px] h-[459px] bg-white rounded">
                <div className="flex mt-[24px]">
                    ...
                    <div className="cursor-pointer text-[30px] ml-[580px]" onClick={()=>complain()} ><IoClose /></div> 
                </div>
                <div className="flex mt-[20px]">
                    <div className="text-base font-semibold ml-[24px] ">Title</div>
                    <div className="text-base font-semibold ml-[550px] mt-[5px] ">To:</div>
                </div>
                <div className="flex">
                    <input className="ml-[24px] w-[556px] h-[38px] text-wrap rounded border border-black border-opacity-20" placeholder="Complaint Title..."></input>
                ...
                <button className="w-[65px] h-[30px] bg-[#4D7CC1] rounded shadow justify-center items-center ml-[700px] mt-2">
                    <div className="text-xs font-semibold text-center text-indigo-50 ">Submit</div>
                </button>
            </div>   
