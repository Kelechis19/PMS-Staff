...
const Evaluation = () =>{
    return (
        ...
        <div className=" mt-4 w-[full] h-[46px] bg-white rounded-tl-lg rounded-tr-lg shadow flex items-center">
          ...
          <div className="text-zinc-500 text-[18px] font-bold pl-[575px] ">Date</div>
          <div className="text-zinc-500 text-[18px] font-bold pl-[132px] ">Response</div>
        </div>
        ...
        <div className="">

            {
              Evaluations.map((item, key) => {
                  return (
                            <TaskRow title={item.title} date={item.date} to={item.to} />
                          )
                })
            }
        </div>
      ...
      <div className=" w-full flex flex-col gap-[10px] ">
        ...
        <div>
          ...
          <div className="w-[full] h-[60px] bg-white shadow flex border-b-[3px] border-b-[#656667]/10 items-center ">
                ...
                <div className="w-[49%]  text-[20px] text-zinc-500  text-start ">{title}</div>
                <div className="w-[28%]  text-[20px] text-zinc-500  text-center ">{date}</div>
                 <div className="flex gap-5 w-[8%]">
                    <button className="w-[3%] text-[20px]"><LuThumbsUp /> </button>
                    <button className="w-[3%] text-[20px]"><LuThumbsDown /> </button>
                 </div>
