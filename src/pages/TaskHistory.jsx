    ...
    return(
        <div className="relative w-full flex flex-row items-center px-[10px] justify-between  bg-white pt-[10px] border-b-[1px] border-b-[#656667]/10">
                ...
                <div className="relative w-[15%] flex ">
                    <div>       {/* style that was here for background color of completed task and all flex  w-[100px] h-[30px] rounded-[4px] ${status==="Not approved"?"bg-red-100 text-red-500":status==="Ongoing"?"bg-green-100 text-green-500":status==="Overdue"?"bg-amber-100 text-amber-300":""} text-center   w-[120px] mb-[25px]*/ }
                        <p>{rating}</p>
                    </div>
                </div>
